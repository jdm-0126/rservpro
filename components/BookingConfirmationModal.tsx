      ...
      <SafeAreaView style={s.container} edges={['top', 'bottom']}>
        <ScrollView contentContainerStyle={s.body} showsVerticalScrollIndicator={false}>
          ...
          <View style={s.detailsCard}>
            ...
            <Row icon="person-outline"   label="Guest"     value={booking.userName} />
            <View style={s.divider} />
            ...
            <View style={s.divider} />
            <Row icon="people-outline"   label="Guests"    value={`${booking.guests} guest${booking.guests !== 1 ? 's' : ''}`} />
          </View>
          ...
          <View style={s.priceCard}>
            ...
            <View style={s.priceRow}>
              ...
              <Text style={s.priceVal}>₱{(booking.totalPrice / (nights || 1)).toLocaleString()}</Text>
            </View>
            <View style={s.priceRow}>
            ...
            <View style={[s.priceRow, s.totalRow]}>
              ...
              <Text style={s.totalVal}>₱{booking.totalPrice.toLocaleString()}</Text>
            </View>
          </View>
