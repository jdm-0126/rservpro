...
export default function AdminDashboard() {
  ...
  const { notifications, unreadCount, markNotificationsRead } = useBookings();
                  ...
                  <View key={n.id} style={[styles.notifCard, !n.read && styles.notifCardUnread]}>
                    ...
                    <View style={{ flex: 1, gap: 4 }}>
                      <View style={styles.notifTopRow}>
                        ...
                        <Text style={styles.notifPrice}>₱{n.totalPrice.toLocaleString()}</Text>
                      </View>
                      <Text style={styles.notifVilla}>{n.villaName}</Text>
                      <Text style={styles.notifMeta}>
                        👤 {n.userName} · 👥 {n.guests} guests
                      </Text>
                      <Text style={styles.notifDates}>
